...
const GestorAlmacen = () => {
    ...
    const createGestor = async () => {
        try {
            const response = await axios.post('/api/almacen', nuevoGestor);
    ...
    const updateGestor = async () => {
        try {
            const response = await axios.put(`/api/almacen/${currentGestor.id}`, nuevoGestor);
    ...
    const deleteGestor = async (gestorId) => {
        try {
            await axios.delete(`/api/almacen/${gestorId}`);
    ...
    const updateGestorInApi = async (updatedGestor) => {
        try {
            await axios.put(`/api/almacen/${updatedGestor.id}`, updatedGestor);
